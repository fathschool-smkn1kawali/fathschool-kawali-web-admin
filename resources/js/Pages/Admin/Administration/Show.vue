            ...
            <div>
                    ...
                    <template v-if="Object.keys(subjects).length > 0">
                        <div class="mb-8 pb-8 border-b-2 border-gray-200 dark:border-gray-600" v-for="(item, index) in subjects"
                            ...
                            <div class="flex items-center mb-3 pl-1">
                                ...
                                <h2 class="text-xl font-bold m-0 dark:text-gray-400"> {{ item[0].subject.course.name }} #{{ index }}
                                </h2>
                            </div>
                ...
                <div v-if="request_data.tab == 'leave-history'">
                    <div class="bg-white dark:bg-gray-800 rounded-lg">
                        <div class="text-lg font-bold dark:text-gray-400 border-b">
                            <div class="px-6 py-4">
                                {{ __('Leave History') }}
                            </div>
                        </div>
                        <div class="p-6 pt-2.5">
                            <div class="flex justify-between font-bold dark:text-gray-400">
                                <div>{{ __('Date') }}</div>
                                <div>{{ __('Status') }}</div>
                            </div>
                            <template v-if="leaves.data.length > 0">
                                <div v-for="leave in leaves.data" :key="leave" class="mt-3 dark:text-gray-400 flex justify-between">
                        ...
                        <pagination class="flex justify-center pb-4" :links="leaves.links" />
                    </div>
                </div>
            </div>
        </div>
