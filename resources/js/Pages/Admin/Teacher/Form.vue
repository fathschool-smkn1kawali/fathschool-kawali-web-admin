                        ...
                        <template v-if="wizard == 2">
                            ...
                            <div
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="flex flex-wrap gap-3 p-1" v-if="teacher && teacher.documents.length > 0">
                                        <div class="relative mt-2" v-for="(doc, index) in teacher.documents" :key="doc.id">
...
export default {
    ...
    data() {
        return {
            wizard: 1,
            date_of_birth_value: this.teacher ? this.teacher.date_of_birth ? dayjs(this.teacher.date_of_birth) : null : null,
            passing_year_value: this.teacher ? this.teacher.profile ? dayjs(this.teacher.profile.passing_year) : null : null,
            validate_errors: {},
            document_size: [1],
            form: useForm({
                ...
                highest_degree_name: this.teacher
                    ? this.teacher.profile ? this.teacher.profile.highest_degree_name : null
                    : null,
                institute_name: this.teacher
                    ? this.teacher.profile ? this.teacher.profile.institute_name : null
                    : null,
                passing_year: this.teacher
                    ? this.teacher.profile ? this.teacher.profile.passing_year : null
                    : null,
                religion: this.teacher
                    ? this.teacher.profile ? this.teacher.profile.religion : null
                    : null,
                nationality: this.teacher
                    ? this.teacher.profile ? this.teacher.profile.nationality : null
                    : null,
    ...
    methods: {
        ...
        submit() {
            ...
            if (this.teacher) {
                this.form.post(
                    this.route("users.update", this.teacher.id),
                    {
                        preserveScroll: true,
                    }
                );
